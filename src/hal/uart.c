...
void UART_Init(const enum UART uart, const uint32_t bps)
{
    ...
    if(uart == UART_0)
    {
        ...
        GPIO_PORTA_PUR_R &= ~0x03;       // Disable Pull-Up resistors of PA0 and PA1
        GPIO_PORTA_PDR_R &= ~0x03;       // Disable Pull-Down resistors of PA0 and PA1
    ...
    else if(uart == UART_1)
    {
        ...
        GPIO_PORTB_PUR_R &= ~0x03;       // Disable Pull-Up resistors of PB0 and PB1
        GPIO_PORTB_PDR_R &= ~0x03;       // Disable Pull-Down resistors of PB0 and PB1
    ...
    else if(uart == UART_2)
    {
        ...
        GPIO_PORTD_PUR_R &= ~0xC0;       // Disable Pull-Up resistors of PD6 and PD7
        GPIO_PORTD_PDR_R &= ~0xC0;       // Disable Pull-Down resistors of PD6 and PD7
    ...
    else if(uart == UART_3)
    {
        ...
        GPIO_PORTC_PUR_R &= ~0xC0;       // Disable Pull-Up resistors of PC6 and P7
        GPIO_PORTC_PDR_R &= ~0xC0;       // Disable Pull-Down resistors of PC6 and PC7
    ...
    else if(uart == UART_4)
    {
        ...
        GPIO_PORTC_PUR_R &= ~0x30;       // Disable Pull-Up resistors of PC4 and PC5
        GPIO_PORTC_PDR_R &= ~0x30;       // Disable Pull-Down resistors of PC4 and PC5
    ...
    else if(uart == UART_5)
    {
        ...
        GPIO_PORTE_PUR_R &= ~0x30;       // Disable Pull-Up resistors of PE4 and PE5
        GPIO_PORTE_PDR_R &= ~0x30;       // Disable Pull-Down resistors of PC4 and PC5
    ...
    else if(uart == UART_6)
    {
        ...
        GPIO_PORTD_PUR_R &= ~0x30;       // Disable Pull-Up resistors of PD4 and PD5
        GPIO_PORTD_PDR_R &= ~0x30;       // Disable Pull-Down resistors of PD4 and PD5
    ...
    else
    {
        ...
        kaOS_SemWait(&gpioMutex[4]);
        GPIO_PORTE_AMSEL_R &= ~0x03;     // Disable analog functions of PE0 and PE1
        GPIO_PORTE_PUR_R &= ~0x03;       // Disable Pull-Up resistors of PE0 and PE1
        GPIO_PORTE_PDR_R &= ~0x03;       // Disable Pull-Down resistors of PD4 and PD5
        GPIO_PORTE_AFSEL_R |= 0x03;      // Enable alternate functions of PE0 and PE1
        GPIO_PORTE_PCTL_R = (GPIO_PORTE_PCTL_R & 0xFFFFFF00) | 0x00000011;    // Set PE0 as Rx and PE1 as Tx
        GPIO_PORTE_DEN_R |= 0x03;            // Enable digital functions of PE0 and PE1
        kaOS_SemSignal(&gpioMutex[4]);
    }
...
void UART_End(const enum UART uart)
{
    ...
    kaOS_SemWait(&UARTClockMutex);
    SYSCTL_RCGCUART_R &= ~(1 << (uart / 0x400)); // Disable clock of the specified UART
