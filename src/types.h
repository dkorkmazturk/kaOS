...
enum UART {UART_0 = 0, UART_1 = 0x400, UART_2 = 0x800, UART_3 = 0xC00, UART_4 = 0x1000, UART_5 = 0x1400, UART_6 = 0x1800, UART_7 = 0x1C00};
enum GPIO_PORT {GPIO_PORT_A = 0, GPIO_PORT_B = 0x400, GPIO_PORT_C = 0x800, GPIO_PORT_D = 0xC00, GPIO_PORT_E = 0x8000, GPIO_PORT_F = 0x8400};
enum GPIO_PIN {GPIO_P0 = 0x1, GPIO_P1 = 0x2, GPIO_P2 = 0x4, GPIO_P3 = 0x8, GPIO_P4 = 0x10, GPIO_P5 = 0x2, GPIO_P6 = 0x40, GPIO_P7 = 0x80};
enum GPIO_MODE {GPIO_OUTPUT, GPIO_INPUT, GPIO_INPUT_PULLUP, GPIO_INPUT_PULLDOWN};
enum I2C {I2C_0 = 0, I2C_1 = 0x400, I2C_2 = 0x800, I2C_3 = 0xC00};
enum I2C_Clock {I2C_100KHz = 100000, I2C_400KHz = 400000, I2C_1MHz = 1000000, I2C_3p4MHz = 3400000};
